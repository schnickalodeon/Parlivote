...
namespace Parlivote.Core.Migrations
{
    ...
    [Migration("20220410162656_RemoveRefreshTokensKeyProblem")]
    partial class RemoveRefreshTokensKeyProblem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parlivote.Shared.Models.Identity.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Parlivote.Shared.Models.Identity.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Parlivote.Shared.Models.Identity.RefreshToken", b =>
                {
                    b.HasOne("Parlivote.Shared.Models.Identity.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
